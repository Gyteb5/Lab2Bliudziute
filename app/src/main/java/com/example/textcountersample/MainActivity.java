...
import com.example.textcountersample.utils.WordsCounter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> arrayAdapter = ArrayAdapter.createFromResource(this, R.array.count_array, android.R.layout.simple_spinner_item);
    ...
    public void btnCalculateOnClick(View view) {
        ...
        if (selection.equalsIgnoreCase(getResources().getString(R.string.word_selection))) {
            int count = WordsCounter.getWordsCount(userInputText);
